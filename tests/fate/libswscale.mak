...
FATE_LIBSWSCALE += fate-sws-floatimg-cmp-gbrapf32le
fate-sws-floatimg-cmp-gbrapf32le: libswscale/tests/floatimg_cmp$(EXESUF)
fate-sws-floatimg-cmp-gbrapf32le: CMD = run libswscale/tests/floatimg_cmp$(EXESUF) -pixel_format gbrapf32le

FATE_LIBSWSCALE += fate-sws-floatimg-cmp-gbrapf16le
fate-sws-floatimg-cmp-gbrapf16le: libswscale/tests/floatimg_cmp$(EXESUF)
fate-sws-floatimg-cmp-gbrapf16le: CMD = run libswscale/tests/floatimg_cmp$(EXESUF) -pixel_format gbrapf16le

FATE_LIBSWSCALE += fate-sws-floatimg-cmp-gbrap16le
fate-sws-floatimg-cmp-gbrap16le: libswscale/tests/floatimg_cmp$(EXESUF)
fate-sws-floatimg-cmp-gbrap16le: CMD = run libswscale/tests/floatimg_cmp$(EXESUF) -pixel_format gbrap16le

FATE_LIBSWSCALE += fate-sws-floatimg-cmp-gbrap10le
fate-sws-floatimg-cmp-gbrap10le: libswscale/tests/floatimg_cmp$(EXESUF)
fate-sws-floatimg-cmp-gbrap10le: CMD = run libswscale/tests/floatimg_cmp$(EXESUF) -pixel_format gbrap10le

FATE_LIBSWSCALE += fate-sws-floatimg-cmp-grayf16le
fate-sws-floatimg-cmp-grayf16le: libswscale/tests/floatimg_cmp$(EXESUF)
fate-sws-floatimg-cmp-grayf16le: CMD = run libswscale/tests/floatimg_cmp$(EXESUF) -pixel_format grayf16le

FATE_LIBSWSCALE += fate-sws-floatimg-cmp-grayf32le
fate-sws-floatimg-cmp-grayf32le: libswscale/tests/floatimg_cmp$(EXESUF)
fate-sws-floatimg-cmp-grayf32le: CMD = run libswscale/tests/floatimg_cmp$(EXESUF) -pixel_format grayf32le
