...
#define output_pixel(pos, val, bias, signedness)                                                             \
    if (big_endian) {                                                                                        \
        AV_WB32(pos, av_float2int(float_mult * (float)(bias + av_clip_ ## signedness ## 16(val >> shift)))); \
    } else {                                                                                                 \
        AV_WL32(pos, av_float2int(float_mult * (float)(bias + av_clip_ ## signedness ## 16(val >> shift)))); \
    }
